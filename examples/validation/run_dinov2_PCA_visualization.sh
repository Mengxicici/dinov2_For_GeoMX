#!/bin/bash
#SBATCH --job-name=dinov2:PCA_visualization              # job name
...
python example_12_run_dinov2_PCA_visualization.py --src "backbone" \
                                          ...
                                          --out "/archive/bioinformatics/Jamieson_lab/shared/spatial-core/ky/mini_pipeline/visualization/PCA"
