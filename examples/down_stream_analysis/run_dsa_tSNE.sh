#!/bin/bash
#SBATCH --job-name=dsa:t-SNE                             # job name
...
python run_dsa_tSNE.py --src "/archive/bioinformatics/Jamieson_lab/shared/spatial-core/ky/Demo_CODEX/output/P2T1_Leiden0.2_clustering.csv" \
                       --out "/archive/bioinformatics/Jamieson_lab/shared/spatial-core/ky/Demo_CODEX/output/P2T1_Leiden0.2_clustering"
