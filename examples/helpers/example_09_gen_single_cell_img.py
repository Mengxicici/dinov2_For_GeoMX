...
# parse args
    ...
    parser.add_argument('--img', type=str, help='tiff file for segmentation')
    parser.add_argument('--seg', type=str, help='csv file for segmentation')
    parser.add_argument('--number', type=int, help='number of inputs single-cell images')
    parser.add_argument('--size', type=int, help='window size of single-cell images')
    args = parser.parse_args()
    raw_path = args.img
    segmentation_file = args.seg
    num_inputs = args.number
    inputs_window_size = args.size
## segmentation
